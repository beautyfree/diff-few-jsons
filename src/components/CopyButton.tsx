...
export default function CopyButton({ versionA, versionB, className = '' }: CopyButtonProps) {
  ...
  return (
    <button
      onClick={handleCopy}
      className={`flex items-center gap-1 px-3 py-1 text-sm bg-primary text-primary-foreground rounded hover:bg-primary/90 ${className}`}
    >
      {copied ? (
        <>
